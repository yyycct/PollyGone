...
URP requires Unity 2021 and URP 11 or newer.
...
Requirements
--------------------------------------------------
- Weather Maker requires Unity 2018.4 or newer.
- Weather Maker requires texture array support.
- Weather Maker is NOT supported on gles 2.0, WebGL and DirectX 9.0 or older.
- Weather Maker does NOT support OpenGL on MAC and iOS. Metal is required.

Setup Instructions
--------------------------------------------------
Project / Scene Setup:
- If Unity 2019.1 or newer, you must enable .NET 4.5 or .NET standard 2.0 in player settings.
...
- Must use Unity 2021.1 or newer with URP 11 or newer.
- Create a new blank Unity project using 3D (standard pipeline) template. The URP template project contains bugs that prevent custom render features from working.
- Import Weather Maker.
- Import URP 11 or newer from package manager.
- Restart Unity.
...
- Ignore parsing errors in the console, they should go away after you click the fix button.
...
Virtual Reality
--------------------------------------------------
Weather Maker supports vr in single pass instanced only, multi-pass and single pass stereo are not officially supported, but you can try your luck.
...
VR works best in Unity 2020 or newer.
