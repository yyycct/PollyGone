...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerTemporalReprojectionState : System.IDisposable
    {
        ...
        /// </summary>
        public RenderTexture PrevDepthTexture { get { return prevDepthTexture; } }
        ...
        /// <summary>
        /// Previous depth threshold
        /// </summary>
        public float PreviousDepthThreshold { get; private set; }
        ...
        private void DisposeRenderTextures()
        {
            ...
            WeatherMakerFullScreenEffect.DestroyRenderTexture(ref prevDepthTexture);
        }
        ...
        public WeatherMakerTemporalReprojectionState(Camera camera, Material reprojMaterial, bool integratedTemporalReprojection)
        {
            ...
            PreviousDepthThreshold = reprojMaterial.GetFloat(WMS._WeatherMakerTemporalReprojectionDepthThreshold);
        }
        ...
        public void PreCullFrame(Camera camera, WeatherMakerDownsampleScale scale, WeatherMakerTemporalReprojectionSize projSize)
        {
            ...
            if (frameWidth != FrameWidth || frameHeight != FrameHeight || ReprojectionSize != projSizeInt)
            {
                ...
                subFrameCurrent = WeatherMakerFullScreenEffect.CreateRenderTexture(descSubFrame, false, FilterMode.Bilinear, TextureWrapMode.Clamp);
                ...
                prevFrameCurrent = WeatherMakerFullScreenEffect.CreateRenderTexture(descPrevFrame, false, FilterMode.Bilinear, TextureWrapMode.Clamp);
                prevFrameCurrent.name = "WeatherMakerTemporalReprojectionPrevFrame";
                RenderTextureDescriptor descPrevDepth = WeatherMakerFullScreenEffect.GetRenderTextureDescriptor(downsampling, projSizeInt, 1, format, 0, camera);
                prevDepthTexture = WeatherMakerFullScreenEffect.CreateRenderTexture(descPrevDepth, false, FilterMode.Point, TextureWrapMode.Clamp);
                prevDepthTexture.name = "WeatherMakerTemporalReprojectionPrevDepth";
        ...
        public void PreRenderFrame(Camera camera, Camera lastNormalCamera, CommandBuffer commandBuffer)
        {
            ...
            commandBuffer.SetGlobalTexture(WMS._TemporalReprojection_PrevDepth, PrevDepthTexture);
            ...
            commandBuffer.SetGlobalFloat(WMS._WeatherMakerTemporalReprojectionDepthThreshold, TemporalReprojectionMaterial.GetFloat(WMS._WeatherMakerTemporalReprojectionDepthThreshold));
