        ...
        private bool PreSetupCommandBuffer(WeatherMakerCommandBuffer cmdBuffer)
        {
            ...
            bool atmosphereOn = WeatherMakerScript.Instance.PerformanceProfile.AtmosphereQuality != WeatherMakerAtmosphereQuality.Disabled && SystemInfo.supportsComputeShaders &&
                ...
                if (WeatherMakerSkySphereScript.Instance != null)
                {
                    ...
                    // blit sky if not using a skybox already
                    ...
                    if (DownSampleScale == WeatherMakerDownsampleScale.Disabled || DownSampleScale == WeatherMakerDownsampleScale.FullResolution)
                    {
                        cmdBuffer.CommandBuffer.Blit(WeatherMakerFullScreenEffect.CameraTargetIdentifier(), WMS._WeatherMakerBackgroundSkyTexture,
                            FullScreenMaterial, 0);
                    }
                    else
                    {
